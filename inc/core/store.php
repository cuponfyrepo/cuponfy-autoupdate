...
function wpcoupon_store_cat_filter() {
	if ( is_tax( 'coupon_store' ) ) {
		...
		$filter_title = wpcoupon_get_option( 'store_sidebar_filter_title', 'Filtrar loja' );
		if( $is_enable_filter ){
	...
	<aside class="widget widget_store_cat_filter">
		...
		<div class="shadow-box">
			...
			<div class="store-filter-sortby-wrapper ui list">
				<h5><?php echo esc_html_e( 'Ordenar por', 'wp-coupon' ); ?></h5>
				<div class="item">
					<label for="store-sortby-newest">
						...
						<span class="filter-sortby-name"><?php echo esc_html_e( 'Mais recente', 'wp-coupon' ); ?></span>
					</label>
				</div>
				<div class="item">
					<label for="store-sortby-popularity">
						...
						<span class="filter-sortby-name"><?php echo esc_html_e( 'Mais popular', 'wp-coupon' ); ?></span>
					</label>
				</div>
				<div class="item">
					<label for="store-sortby-endingsoon">
						...
						<span class="filter-sortby-name"><?php echo esc_html_e( 'Acaba em breve', 'wp-coupon' ); ?></span>
					</label>
				</div>
				<div class="item">
					<label for="store-sortby-expired">
						...
						<span class="filter-sortby-name"><?php echo esc_html_e( 'Expirado', 'wp-coupon' ); ?></span>
					</label>
				</div>
			</div>
		</div>
