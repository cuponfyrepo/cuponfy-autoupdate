...
class WPCoupon_Categories extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Cuponfy Categoria', 'wp-coupon' ), // Name
            array(
                'description' => esc_html__( 'Insira qualquer taxonomia como lista de categorias', 'wp-coupon' ),
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'taxonomy' ); ?>"><?php esc_html_e( 'Taxonomia:', 'wp-coupon' ); ?></label>
        ...
        <div>
            <label for="<?php echo $this->get_field_id( 'depth' ); ?>"><?php esc_html_e( 'Profundidade:', 'wp-coupon' ); ?></label>
            <?php

            $depth = array(
                '0' => '<code>0</code> - ' . esc_html__( 'Todas as categorias e categorias filhas', 'wp-coupon' ),
                '-1' => '<code>-1</code> -' . esc_html__('Todas as categorias exibidas em forma plana (sem recuo) (substitui hierárquica)', 'wp-coupon' ),
                '1' => '<code>1</code> - ' . esc_html__( 'Mostre apenas categorias de topo', 'wp-coupon' ),
                'n' => '<code>n</code> - ' . esc_html__( 'Valor de n (um número) especifica a profundidade (ou nível) para descer na exibição de categorias', 'wp-coupon' ),
            );
        ...
        <p>
            ...
            <select name="<?php echo $this->get_field_name( 'orderby' ); ?>">
                ...
                $a = array(
                    ...
                    'name'  => esc_html__( 'Nome', 'wp-coupon' ),
                ) ;
                foreach ( $a as $k => $v ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Número de lojas para mostrar:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'show_count' ); ?>"><?php esc_html_e( 'Mostrar número de cupons?', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'item_per_row' ); ?>"><?php esc_html_e( 'Número de itens por linha:', 'wp-coupon' ); ?></label>
