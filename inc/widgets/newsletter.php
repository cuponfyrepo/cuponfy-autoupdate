...
class WPCoupon_Newsletter extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Cuponfy Newsletter', 'wp-coupon' ), // Name
            array(
                'description' => esc_html__( 'Configura a captura de Leads', 'wp-coupon' ),
        ...
        <div class="newsletter-box-wrapper shadow-box">
            <form id="<?php echo $form_id; ?>" method="post" action="<?php echo esc_attr( $instance['mailchimp'] ) ?>" target="_blank">
                ...
                <div class="ui action left icon input">
                    <input class="submit-input" type="email" required="required" name="EMAIL" placeholder="<?php esc_attr_e( 'Digite aqui seu melhor Email...', 'wp-coupon' ); ?>">
                    <i class="mail outline icon"></i>
                    <div class="submit-btn ui button" onclick="document.getElementById('<?php echo $form_id; ?>').submit();"><?php esc_html_e( 'Inscreva-se', 'wp-coupon' ); ?></div>
                </div>
                <div class="clear"></div>
    ...
    public function form( $instance ) {
        ...
        <div>
            <label for="<?php echo $this->get_field_id( 'mailchimp' ); ?>"><?php esc_html_e( 'Integração Mailchimp:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'before_form' ); ?>"><?php esc_html_e( 'Antes do Form', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'after_form' ); ?>"><?php esc_html_e( 'Depois do Form', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'facebook' ); ?>"><?php esc_html_e( 'URL Facebook:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'twitter' ); ?>"><?php esc_html_e( 'URL Twitter:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'linkedin' ); ?>"><?php esc_html_e( 'URL Linkedin:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'flickr' ); ?>"><?php esc_html_e( 'URL Flickr:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'youtube' ); ?>"><?php esc_html_e( 'URL Youtube:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'instagram' ); ?>"><?php esc_html_e( 'URL Instagram:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'pinterest' ); ?>"><?php esc_html_e( 'URL Pinterest:', 'wp-coupon' ); ?></label>
        ...
        <p class="link-target">
            <label for="<?php echo $this->get_field_id( 'link_target' ); ?>"><?php esc_html_e( 'Target dos Links', 'wp-coupon' ); ?></label>
