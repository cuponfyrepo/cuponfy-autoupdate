...
class WPCoupon_Sidebar_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Cuponfy Barra Lateral', 'wp-coupon' ), // Name
            array(
                'description' => esc_html__( 'Insira Barra Lateral', 'wp-coupon' ),
    ...
    public function form( $instance ) {
        ...
        <p class="st-widget-sidebar-settings">
            <label for="<?php echo $this->get_field_id( 'sidebar' ); ?>"><?php esc_html_e( 'Barra Lateral', 'wp-coupon' ); ?></label>
