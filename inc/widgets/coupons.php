...
class WPCoupon_Coupons_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'st_coupons', // Base ID
            esc_html__( 'Cuponfy Cupons', 'wp-coupon' ), // Name
            array(
                'description' => esc_html__( 'Insira seus cupons na sua página', 'wp-coupon' ),
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'posts_per_page' ); ?>"><?php esc_html_e( 'Número de cupons para mostrar:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'num_words' ); ?>"><?php esc_html_e( 'Comprimento do texto:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'num_words_no_thumb' ); ?>"><?php esc_html_e( 'Comprimento do texto escondendo a thumbnail:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'layout' ); ?>"><?php esc_html_e( 'Layout da Caixa:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'show_paging' ); ?>"><?php esc_html_e( 'Mostrar Paginação:', 'wp-coupon' ); ?></label>
            <select name="<?php echo $this->get_field_name( 'show_paging' ); ?>">
                <?php
                $a = array(
                    '' => esc_html__( 'Não', 'wp-coupon' ),
                    'yes'  => esc_html__( 'Sim', 'wp-coupon' ),
                ) ;
                foreach ( $a as $k => $v ) {
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'hide_expired' ); ?>"><?php esc_html_e( 'Não mostrar cupons expirados.', 'wp-coupon' ); ?></label>
        </p>
        <hr>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'hide_latest' ); ?>"><?php esc_html_e( 'Ocultar aba de cupons mais recentes', 'wp-coupon' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'show_popular' ); ?>"><?php esc_html_e( 'Mostrar aba de cupons populares', 'wp-coupon' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'show_ending_soon' ); ?>"><?php esc_html_e( 'Mostras última aba', 'wp-coupon' ); ?></label>
        </p>
        <?php
    }
