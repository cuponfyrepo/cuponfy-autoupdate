...
class WPCoupon_Slider_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'st_slider', // Base ID
            esc_html__( 'Cuponfy Slider', 'wp-coupon' ), // Name
            array(
                'description' => esc_html__( 'Insira um Slider', 'wp-coupon' ),
    ...
    public function form( $instance ) {
        ...
        <div class="st-widget-ui-items" id="<?php echo esc_attr( $id ); ?>">
            ...
            <a href="#" class="button-secondary new-item"><?php esc_html_e( 'Adicionar Item', 'wp-coupon' ); ?></a>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'slideSpeed' ); ?>"><?php esc_html_e( 'Veloc. do Slide (milissegundo)', 'wp-coupon' ); ?></label>
