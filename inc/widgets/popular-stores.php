...
class WPCoupon_Popular_Store extends WP_Widget {
    ...
    */
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Cuponfy Lojas em Destaque', 'wp-coupon' ), // Name
            array( 'description' => esc_html__( 'Mostre as principais suas principais lojas', 'wp-coupon' ), ) // Args
        );
    }
    ...
    */
    public function form( $instance ) {
        ...
        $title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Lojas Populares', 'wp-coupon' );
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Número de lojas:', 'wp-coupon' ); ?></label>
        ...
        <p>
            ...
            <select name="<?php echo $this->get_field_name( 'orderby' ); ?>">
                <?php foreach ( array(
                                    ...
                                    'count' => esc_html__( "Quantidade de Cupons", 'wp-coupon' ),
