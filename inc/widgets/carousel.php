...
class WPCoupon_Carousel_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'st_carousel', // Base ID
            esc_html__( 'Cuponfy Carrossel de Lojas', 'wp-coupon' ), // Name
            array(
                'description' => esc_html__( 'Insira um carrossel de lojas em destaque', 'wp-coupon' ),
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Título:', 'wp-coupon' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'featured_only' ); ?>"><?php esc_html_e( 'Apenas lojas em Destaque(Featured).', 'wp-coupon' ); ?></label>
        </p>

        <p>
            <label for="<?php echo $this->get_field_id( 'include' ); ?>"><?php esc_html_e( 'Incluir:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'exclude' ); ?>"><?php esc_html_e( 'Excluir:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Quantas lojas para mostrar?', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'orderby' ); ?>"><?php esc_html_e( 'Ordenar por:', 'wp-coupon' ); ?></label>
            <select name="<?php echo $this->get_field_name( 'query' ).'[orderby]'; ?>">
                <?php
                $a = array(
                    'none'  => esc_html__( 'Padrão', 'wp-coupon' ),
                    'count'  => esc_html__( 'Número de cupons', 'wp-coupon' ),
                    'name'  => esc_html__( 'Título', 'wp-coupon' ),
                    'id'  => esc_html__( 'Preservar a ordem de ID da loja fornecida nos IDs "Incluir"', 'wp-coupon' ),
                ) ;
                foreach ( $a as $k => $v ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'order' ); ?>"><?php esc_html_e( 'Ordem:', 'wp-coupon' ); ?></label>
            <select name="<?php echo $this->get_field_name( 'query' ).'[order]'; ?>">
                <?php
                $a = array(
                    'desc' => esc_html__( 'Decrescente', 'wp-coupon' ),
                    'asc'  => esc_html__( 'Crescente', 'wp-coupon' ),
                );
                foreach (  $a as $k => $v ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'slideSpeed' ); ?>"><?php esc_html_e( 'Veloc. do Slider (milissegundo)', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'paginationSpeed' ); ?>"><?php esc_html_e( 'Veloc. da Paginação (milissegundo)', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label><?php esc_html_e( 'Número de itens visíveis:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label><?php esc_html_e( 'Número de itens visível no Tablet:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label><?php esc_html_e( 'Número de itens visíveis no celular:', 'wp-coupon' ); ?></label>
         ...
         <p>
            <label ><?php esc_html_e( 'Play Automático:', 'wp-coupon' ); ?></label>
        ...
        <p>
            <label ><?php esc_html_e( 'Pausar com Mouse:', 'wp-coupon' ); ?></label>
            <select name="<?php echo $this->get_field_name( 'controls' ).'[stopOnHover]'; ?>">
                <?php
                $a = array(
                    'true' => esc_html__( 'Sim', 'wp-coupon' ),
                    'false'  => esc_html__( 'Não', 'wp-coupon' ),
                );
                foreach (  $a as $k => $v ) {
